...
freqrange=[1000:20:3000]; %frequency in Hz
trig = 1;

amp=.4; %amplitude in V
...
filename=sprintf('Experimental Data/%s/M0P0R1-1T', d); %must change to file that you want to save to
